...
def spike_motion_plot(
    ...
    (
        ...
        do_plot=False,  # change T/F whether to plot sorting plots also
    ...
    line = plt.plot(dataSet[0], dataSet[1], dataSet[2], lw=1, c="b", linestyle="dotted", alpha=0.7)[
        0
    ]  # For line plot
    ...
    for i in MU_spikes_by_channel_dict["13"]["500"]:  # ['7']['1700'] #['13']['500']
        ...
        ax.plot(
            x_points[spike_slice],
            y_points[spike_slice],
            z_points[spike_slice],
            marker="x",
            lw=1.2,
            c="red",
        )
