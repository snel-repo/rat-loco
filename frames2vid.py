...
def frames2vid(base_filename, num_frames, downsampling_factor=1, destination='.', num_cams=4, framerate=100): #bottom_cam_id=0
...
if __name__ == '__main__':
     ...
     if len(list(sys.argv)) == 3:
          ...
          frames2vid(base_filename=sys.argv[1], num_frames=sys.argv[2], downsampling_factor=sys.argv[3], destination=sys.argv[4], num_cams=sys.argv[5])
     elif len(list(sys.argv)) == 7:
          frames2vid(base_filename=sys.argv[1], num_frames=sys.argv[2], downsampling_factor=sys.argv[3], destination=sys.argv[4], num_cams=sys.argv[5], framerate=sys.argv[6])
     else:
