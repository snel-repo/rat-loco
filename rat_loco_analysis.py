import import_OE_data, import_anipose_data
import process_spikes, process_steps, cluster_steps, pandas_eda 
...
camera_fps=125#100
vid_length=10#20
time_frame=[0,0.95] # 2-element list slicing between 0 and 1, e.g., [0,.5], set to 1 for full ephys plotting
bin_width_ms=10
