...
def rat_loco_analysis(chosen_rat, OE_dict, KS_dict, anipose_dict, CH_colors, MU_colors, CFG):
    if 'multi' not in CFG['plotting']['plot_type']:
        # function for calling all analysis functions. Only chosen "plot_type" is executed
        if CFG['plotting']['plot_type'] == "sort":
            ...
            raster(chosen_rat, OE_dict, KS_dict, anipose_dict, CH_colors, MU_colors, CFG)
        elif CFG['plotting']['plot_type'] == "smooth":
            from process_spikes import smooth
            smooth(chosen_rat, OE_dict, KS_dict, anipose_dict, CH_colors, MU_colors, CFG)
...
if __name__ == "__main__":    
    ...
    OE_dict = import_OE_data(chosen_rat, CFG)
    anipose_dict = import_anipose_data(chosen_rat, CFG)
    if CFG['analysis']['sort_method'] =='kilosort':
        KS_dict = import_KS_data(chosen_rat, CFG)

    rat_loco_analysis(chosen_rat, OE_dict, KS_dict, anipose_dict, CH_colors, MU_colors, CFG)
    ...
    #         num_sessions = len(chosen_rat['session_date'])
    ...
    #         iplot(big_fig)
    #     else:
    #         plot_type = CFG['plotting']['plot_type']
