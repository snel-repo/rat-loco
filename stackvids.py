...
def stackvids(base_filename, destination='.', stack_type='hstack', num_cams=3):
     ...
     if num_cams==2:
          os.system(f'ffmpeg -i {base_filename}_cam0.mp4 -i {base_filename}_cam1.mp4 -i -filter_complex {stack_type}=inputs=2 {destination}/stack_{base_filename}.mp4')
     elif num_cams==3:
